...
?>
	...
	<div class="content">
		...
		<div class="row mt-2">
				...
				<div class="d-flex">
				<img src="background.jpg " width="285px">
				</div>
				<div class="d-flex">
				<img src="avatar.jpg" class="ava" class="ml-2">
				<div class="">
				<a href="">Marsel</a> 
				</div>
				<div class="">
...
<?php for ($i=0; $i < $query->num_rows; $i++) { ?>
	<div class="row">
		...
		<div class="col-2">
	<a href=""><?php $marsel = $query->fetch_assoc(); echo '<img src = "' . $marsel['logo'] .'">'; ?></a>
			</div>
			<div class="col-10">
			...
			<h3><a href=""><?php  echo $marsel['title'];  ?></a></h3>		
							...
							<div>
									<?php echo  '<img class="w-100" src = "' . $marsel['img'] .'">'; ?>
							...
							<div class="col-2">
								<a href=""><?php $ur = $query->fetch_assoc(); echo '<img src = "' . $ur['logo'] .'">'; ?></a>
							</div>
							<div>
							<h3><a href=""><?php echo $ur['title'] ?></a></h3>
							</div>
							<div>
									<?php echo $ur['text'] ?>
							</div>
							<div>
									<?php echo '<img class="w-100" src = "' . $ur['img'] .'">'; ?>
							</div>
	

									<p><?php echo $marsel['id']; ?></p>
							...
							<form action="change.php" method="POST">
								<?php echo '<input style=   name="text" value="' .$marsel['text']. '">	'; ?>
								<?php echo '<input style=   name="id" value="' .$marsel['id']. '">	'; ?>
